                        ...
                        <div className="relative p-4 w-full max-w-md bg-white rounded-lg shadow ">
                            ...
                            <form onSubmit={handleSubmit} className="p-4 md:p-5">
                                <div className="grid gap-4 mb-4 grid-cols-2">
                                    ...
                                    {/*           className="block mb-2 text-sm font-medium text-gray-900 ">Categoria</label>*/}
                                    {/*    <select id="category"*/}
                            ...
                            <td className="px-6 py-4 text-right">
                                <div className="flex justify-end items-center space-x-4">
                                    ...
                                    <button
                                        ...
                                        className="flex items-center text-red-700 hover:text-red-800 font-medium">
                    ...
                    <div
                        ...
                        <div className="relative p-4 w-full max-w-md bg-white rounded-lg shadow">
                            <div className="flex items-center justify-between p-4 md:p-5 border-b rounded-t">
                                ...
                                <button
                                    onClick={() => setIsEditModalOpen(false)} // Função para fechar o modal
                                    className="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center"
                                >
                                    <FaTimes size={16}/>
                                    <span className="sr-only">Close modal</span>
